---
title : "Tạo hàm lambda tìm kiếm đoạn video"
date :  "2024-10-27" 
weight : 1
chapter : false
pre : " <b> 4.1 </b> "
...
#### Mục tiêu
Tạo hàm Lambda mang tên **video-search** có nhiệm vụ tiếp nhận yêu cầu từ người dùng (text hoặc hình ảnh), chuyển đổi chúng thành vector embedding thông qua Bedrock, sau đó truy vấn vào OpenSearch để tìm đoạn video phù hợp nhất.
...
2. Cấu hình cơ bản cho hàm:
   - **Memory**: `512 MB`.
   - **Timeout**: `30 sec`.
![](/images/4-1/08.png?width=50pc)

3. Cấu hình biến môi trường:
   - **OPENSEARCH_HOST**: (Endpoint OpenSearch của bạn).
   - **OPENSEARCH_INDEX**: `video-segments-index`.
   - **TABLE_NAME**: `video-analysis`.
   - **VIDEO_BUCKET**: (Bucket chứa video để tạo link xem thử).
![](/images/4-1/03.png?width=50pc)

4. Gán Lambda Layer:
   - Tương tự như bước 3.8, chúng ta cần gán layer `opensearch-py-layer` để hàm có thể sử dụng thư viện OpenSearch.
![](/images/4-1/05.png?width=50pc)
![](/images/4-1/07.png?width=50pc)

5. Tại tab **Code**, dán đoạn mã nguồn xử lý tìm kiếm đa phương thức:
